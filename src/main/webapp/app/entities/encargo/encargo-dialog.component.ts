...
export class EncargoDialogComponent implements OnInit {
    ...
    valordominiosEstado: ValorDominio[];
    valordominiosTipoEvento: ValorDominio[];
    constructor(
    ...
    ngOnInit() {
        ...
        this.valorDominioService.queryEstado().subscribe(
            (res: Response) => { this.valordominiosEstado = res.json(); }, (res: Response) => this.onError(res.json()));
        this.valorDominioService.queryTipoEvento().subscribe(
            (res: Response) => { this.valordominiosTipoEvento = res.json(); }, (res: Response) => this.onError(res.json()));
    }
    clear () {
